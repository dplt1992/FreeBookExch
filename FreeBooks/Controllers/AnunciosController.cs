...
namespace FreeBooks.Controllers
{
    public class AnunciosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Anuncios.Include(a => a.Transacao).Include(a => a.Utilizador);
        ...
        public async Task<IActionResult> Create([Bind("IdAnuncio,Titulo,Tipo,Descricao,Estado,DataLancamento,DataExpiracao,UtilizadorFk,TransacaoFk")] Anuncios anuncios)
        {
            ...
            ViewData["TransacaoFk"] = new SelectList(_context.Transacoes, "IdTransacao", "IdTransacao", anuncios.TransacaoFk);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAnuncio,Titulo,Tipo,Descricao,Estado,DataLancamento,DataExpiracao,UtilizadorFk,TransacaoFk")] Anuncios anuncios)
        {
