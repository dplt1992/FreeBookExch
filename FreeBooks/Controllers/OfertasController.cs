...
namespace FreeBooks.Controllers
{
    public class OfertasController : Controller
    {
        ...
        public Livros addLivroToDB(string titulo, string desc, int edicao, string editora, string autor, int oferta) {
            return new Livros
            {
                Titulo = titulo,
                Descricao = desc,
        ...
        public Ofertas addOfertaToDB(string titulo, string tipo, string disc, Decimal price, DateTime dataExp, Utilizadores user)
        {
            return new Ofertas
            {
                Descricao = disc,
